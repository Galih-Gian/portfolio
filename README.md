...
<body>
  ...
  <section id="home" class="bg-slate-800 pb-15 pt-30">
    <div class="w-12/12 md:container mx-auto text-center flex items-center justify-center">
      <div class="px-2 md:px-4">
        <h3 class="font-bold text-white text-3xl md:text-5xl md:mb-4 flex justify-center gap-2">Talk <span
            class="text-sky-500">Class </span>Do More <span class="fill-current text-sky-500 hover:text-sky-200"><svg
              width="50" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- end home -->
  <!-- service -->
  <section id="service" class="bg-slate-700 md:pb-20 pb-80">
    <div class="w-12/12 md:container mx-auto h-screen pt-10">
      <h3
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5 justify-center mt-10 px-4">
        <div class="flex  bg-white space-x-1 md:space-x-5 rounded-xl shadow-lg px-2 py-3 md:px-5">
          <img src="/img/averie-woodard-5d20kdvFCfA-unsplash.jpg" class="w-[100px] md:w-[250px] rounded-xl shadow-lg"
            alt="">
          <div class=" px-2 md:px-4">
            <h2 class="font-semibold text-xl md:text-2xl text-slate-800">Lorem ipsum dolor</h2>
            <p class="text-slate-400 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod Lorem ipsum
              dolor sit
              amet consectetur!</p>
            <a href="" class="bg-sky-700 py-2 px-3 md:px-5 rounded-lg text-slate-200 font-semibold">Selanjutnya</a>
          </div>

        </div>
        <div class="flex justify-center bg-white space-x-2 md:space-x-5 rounded-xl shadow-lg py-3 px-2 md:px-5">
          <img src="/img/william-white-cF6fz9QwfrY-unsplash.jpg" class="w-[100px] md:w-[250px] rounded-xl shadow-lg" alt="">
          <div class="px-2 md:px-4">
            <h2 class="font-semibold text-xl md:text-2xl text-slate-800">Lorem ipsum dolor</h2>
            <p class="text-slate-400 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod Lorem ipsum
        ...
        <div class="flex justify-center bg-white space-x-2 md:space-x-5 rounded-xl shadow-lg py-3 px-2 md:px-5">
          <img src="/img/mohamed-nohassi-odxB5oIG_iA-unsplash.jpg" class="w-[100px] md:w-[250px] rounded-xl shadow-lg" alt="">
          <div class="px-2 md:px-4">
            <h2 class="font-semibold text-xl md:text-2xl text-slate-800">Lorem ipsum dolor</h2>
            <p class="text-slate-400 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod Lorem ipsum
              dolor sit amet consectetur!</p>
        ...
        <div class="flex justify-center bg-white space-x-2 md:space-x-5 rounded-xl shadow-lg py-3 px-2 md:px-5">
          <img src="/img/nathan-mcbride-RP6Ba_6U154-unsplash.jpg" class="w-[100px] md:w-[250px] rounded-xl shadow-lg" alt="">
          <div class="px-2 md:px-4">
            <h2 class="font-semibold text-xl md:text-2xl text-slate-800">Lorem ipsum.</h2>
            <p class="text-slate-400 mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod Lorem ipsum
              dolor sit amet consectetur!</p>
            <a href="" class="bg-sky-700 py-2 px-3 md:px-5 rounded-lg text-slate-200 font-semibold">Selanjutnya</a>
          </div>
  ...
  <section id="about" class="bg-slate-700 pt-7 pb-5">
    <div class="md:container px-2 mx-auto">
      <div class="w-full md:flex justify-center gap-8">
        <img src="/img/averie-woodard-5d20kdvFCfA-unsplash.jpg" alt=""class="w-[300px] md:w-[400px] mx-auto rounded-lg"
          class="w-[400px] rounded-[100%] border-4 border-slate-300">
      ...
      <div class="flex justify-end items-center  pt-5 gap-7">
